...
<tr>
	<td class="text-center">
		<form action="cartHandler.php? method="get">
        	<input type="hidden" id="userID" name="userID" value="<?php echo $cart[$x]['userID'] ?>">
        	<input type="hidden" id="productID" name="productID" value="<?php echo $cart[$x]['productID'] ?>">
        	<input type="hidden" id="add" name="add" value="false">
        	<button type="submit" class="btn-sm btn-secondary border border-warning" role="button">Remove</button>
        </form>
	</td>
	<td class="text-center">
		<?php echo $cart[$x]['ID']; ?>
...
<?php    
    echo 
    "<td>" . $cart[$x]['carMake'] . "</td>" .
    "<td>" . $cart[$x]['carModel'] . "</td>" .
    "<td class='text-center'>" . $cart[$x]['carYear'] . "</td>" .
    "<td class='text-center'>$" . $cart[$x]['carPrice'] . "</td>";
    echo "</tr>";
