    				...
    				<div class="card-body text-left bg-info">
						...
						<div class="input-group mb-3">
							<div class="input-group-prepend">
  							...
  							<input type="text" class="form-control" name="carMake" value="<?php echo $product[0]['carMake'] ?>" aria-label="Make" aria-describedby="make-addon">
						</div>
						<hr>
						<div class="input-group mb-3">
							<div class="input-group-prepend">
  							...
  							<input type="text" class="form-control" name="carModel" value="<?php echo $product[0]['carModel'] ?>" aria-label="Model" aria-describedby="model-addon">
						</div>
						<hr>
						<div class="input-group mb-3">
							<div class="input-group-prepend">
  							...
  							<input type="text" class="form-control" name="carYear" value="<?php echo $product[0]['carYear'] ?>" aria-label="Year" aria-describedby="year-addon">
						</div>
						<hr>
						<div class="input-group mb-3">
							<div class="input-group-prepend">
  							...
  							<input type="text" class="form-control" name="carVin" value="<?php echo $product[0]['carVin'] ?>" aria-label="VIN" aria-describedby="vin-addon">
						</div>
						<hr>
						<div class="input-group mb-3">
							<div class="input-group-prepend">
  							...
  							<input type="text" class="form-control" name="carPrice" value="<?php echo $product[0]['carPrice'] ?>" aria-label="Price" aria-describedby="price-addon">
  							<div class="input-group-append">
						...
						<div class="input-group">
                          ...
                          <textarea class="form-control" name="carDescription" aria-label="description"><?php echo $product[0]['carDescription'] ?></textarea>
                        </div>
                        <hr>
                    </div>
                    <div class="card-footer bg-dark text-light border-warning">
                		<button class="btn btn-secondary" data-toggle="confirmation" name="productEditSave" type="submit">Submit</button>
                	</div>
                </form>
        	</div>
    	</div>
