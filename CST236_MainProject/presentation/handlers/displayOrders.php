...
$orders = $dbservice->getOrdersHistory($_SESSION['ID']);
...
<body>
	...
	<nav class="navbar navbar-expand-md navbar-dark bg-dark mb-4">
		...
		<h3 class="text-white mt-1">Order History</h3>
		...
		<div class="col-sm-12 col-md-6">
			<div class="card mb-4">
				<div class="card-body text-center bg-success">
					<h3 class="card-title">Purchase Successful!</h3>					
				</div>
			</div>
		</div>
	</div>
...
<?php endif;
    ...
    $_SESSION['editFailReason'] = "You have no order history";
